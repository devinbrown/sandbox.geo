...
(function() {
  ...
  CATMAP.load_map = function(map_div_name) {
    ...
    kmlDir = "kml";
    nex_mosaic = new OpenLayers.Layer.Image('radar.NEXRAD.mosaic 1', 'img/map_radar_1.gif', new OpenLayers.Bounds(-127.650375523875420, 21.652538062803, -66.577937876818, 50.436626367301044).transform(geoProj, mercProj), new OpenLayers.Size(3400, 1600), {
      isBaseLayer: false,
      alwaysInRange: true
    });
    map.addLayers([nex_mosaic]);
    nex_mosaic.setOpacity(.5);
    nex_mosaic2 = new OpenLayers.Layer.Image('radar.NEXRAD.mosaic 2', 'img/map_radar_2.png', new OpenLayers.Bounds(-127.650375523875420, 21.652538062803, -66.527937876818, 50.436626367301044).transform(geoProj, mercProj), new OpenLayers.Size(3400, 1600), {
      isBaseLayer: false,
      alwaysInRange: true
    });
